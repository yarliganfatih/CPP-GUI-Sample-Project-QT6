...
Window::Window()
{
    ...
    sourceGroupBox = new QGroupBox(tr("Original Modal"));
    sourceGroupBox->setLayout(sourceLayout);
    //! [2]

    //! [3]
    filterWidget = new FilterWidget;
    filterWidget->setText(tr("Fatih|Gotham"));
    connect(filterWidget, &FilterWidget::filterChanged, this, &Window::textFilterChanged);

    filterPatternLabel = new QLabel(tr("&Search Pattern:"));
    ...
    proxyView->sortByColumn(0, Qt::AscendingOrder); //default sorted
    ...
    proxyGroupBox = new QGroupBox(tr("Search & Filter"));
